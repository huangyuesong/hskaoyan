...
/***/ function(module, exports, __webpack_require__) {
	...
	var District = function () {
		...
		_createClass(District, [{
			...
			key: 'renderRow',
			value: function renderRow(colleges) {
				var _this = this;

				var row = $('<div class="row"></div>');

				colleges.map(function (_college) {
					row.append(_this.renderCollege(_college.id, _college.college));
				});
			...
			value: function render() {
				var _district = $(['<div class="section district">', '\t<div class="title">', '\t\t<span>' + this.district + '</span>', '\t</div>', '\t<div class="content"></div>', '</div>'].join(''));
		...
		function Forum() {
				...
				ajaxGetData: function ajaxGetData() {
					$.ajax({
						...
						success: function success(data) {
							var list = data.list;
							var list_flink = data.list_flink;


							_this2.model.collegeList = list;
							_this2.model.linkList = list_flink;
							_this2.view.setDistrict();
							_this2.view.setOtherSite();
						},
			...
			this.view = {
				setDistrict: function setDistrict() {
					var collegeList = _this2.model.collegeList;


					collegeList.map(function (_district) {
						var district = _district.district;
						var list = _district.list;


						var __district = new District({
							district: district,
							list: list
						}).render();
				...
				setOtherSite: function setOtherSite() {
					var linkList = _this2.model.linkList;

					var content = $('.content', $('.section + .other-site'));

					content.children().remove();

					linkList.map(function (_link) {
						var name = _link.name;
						var href = _link.href;


						var link = $(['<span class="link">', '\t<a href="' + href + '" target="_blank">' + name + '</a>', '</span>'].join(''));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/.npminstall/sass-loader/3.2.0/sass-loader/index.js!./forum.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/.npminstall/sass-loader/3.2.0/sass-loader/index.js!./forum.scss");
