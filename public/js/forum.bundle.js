...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(District, [{
			...
			value: function renderRow(colleges) {
				...
				colleges.map(function (_college) {
					_row.append(_this.renderCollege(_college.id, _college.college));
				});
	...
	var Management = function () {
		...
		_createClass(Management, [{
			key: 'render',
			value: function render() {
				return $(['<div class="management">', '\t<div class="title">', '\t\t<span>站务管理</span>', '\t</div>', '\t<div class="content">', '\t\t<div class="row">', '\t\t\t<span class="mng-link">', '\t\t\t\t<a href="' + 'javascript:void(0)' + '">站务公告</a>', '\t\t\t\t<span class="unread">(1)</span>', '\t\t\t</span>', '\t\t\t<span class="mng-link">', '\t\t\t\t<a href="' + 'javascript:void(0)' + '">举报建议和咨询</a>', '\t\t\t\t<span class="unread">(1)</span>', '\t\t\t</span>', '\t\t\t<span class="mng-link">', '\t\t\t\t<a href="' + 'javascript:void(0)' + '">版主申请</a>', '\t\t\t\t<span class="unread">(1)</span>', '\t\t\t</span>', '\t\t</div>', '\t\t<div class="row">', '\t\t\t<span class="mng-link">', '\t\t\t\t<a href="' + 'javascript:void(0)' + '">站务公告</a>', '\t\t\t\t<span class="unread">(1)</span>', '\t\t\t</span>', '\t\t\t<span class="mng-link">', '\t\t\t\t<a href="' + 'javascript:void(0)' + '">举报建议和咨询</a>', '\t\t\t\t<span class="unread">(1)</span>', '\t\t\t</span>', '\t\t\t<span class="mng-link">', '\t\t\t\t<a href="' + 'javascript:void(0)' + '">版主申请</a>', '\t\t\t\t<span class="unread">(1)</span>', '\t\t\t</span>', '\t\t</div>', '\t</div>', '</div>'].join(''));
			}
		}]);
	...
	$(function () {
		...
		districts.map(function (_district) {
