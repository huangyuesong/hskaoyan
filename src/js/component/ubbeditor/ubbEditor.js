module.exports = function ubbEditor(_id)
{
  ...
  this.tLoadLinkTable = function()
  {
    ...
    tLinkTableHTML += '  <tr>';
    tLinkTableHTML += '    <td height="20" valign="top">' + ubbEditorLang.tLinkURL + '</td>';
    tLinkTableHTML += '  </tr>';
    tLinkTableHTML += '  <tr>';
  ...
  this.tLoadImageTable = function()
  {
    ...
    tLinkTableHTML += '  <tr>';
    tLinkTableHTML += '    <td height="20" valign="top">' + ubbEditorLang.tImageURL + '</td>';
    tLinkTableHTML += '  </tr>';
    tLinkTableHTML += '  <tr>';
  ...
  this.tLoadSmileyTable = function()
  {
    ...
    tSmileyTableHTML += '  <tr>';
    tSmileyTableHTML += '    <td colspan="' + tRowNum + '" height="20" valign="top">' + ubbEditorLang.tSmileyImage + '</td>';
    tSmileyTableHTML += '  </tr>';
    tSmileyTableHTML += '  <tr>';
  ...
  this.tLoadForeColorTable = function()
  {
    ...
    tColorTableHTML += '  <tr>';
    tColorTableHTML += '    <td colspan="' + tRowNum + '" height="20" valign="top">' + ubbEditorLang.tColorPicker + '</td>';
    tColorTableHTML += '  </tr>';
    tColorTableHTML += '  <tr>';
